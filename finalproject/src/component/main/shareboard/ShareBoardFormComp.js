   ...
   state={       
    ...
    uploadImage=(e)=>{
         ...
         upload.append("uploadFile", uploadFile);
          ...
          let url="http://ec2-3-36-28-35.ap-northeast-2.compute.amazonaws.com:8080/FinalProjectSpringBoot1/share/upload";
       ...
       onDataInsert=()=>{
         ...
         console.log(subject + ", " + addr + ", " + content);
          ...
          //db 에 insert
          let url="http://ec2-3-36-28-35.ap-northeast-2.compute.amazonaws.com:8080/FinalProjectSpringBoot1/share/insert";
